...
const albumTracks = [
    {
        ...
        subtitle: "23rd December 2025",
        url: "https://youtu.be/kbB_AaW6RtU?si=_E-dPF5jvzwLAPYL&t=1",
        embedId: "kbB_AaW6RtU",
        startTime: 1,
    ...
    },
    {
        ...
        subtitle: "The Days we got closer",
        url: "https://youtu.be/RI-HOQ27QEM?si=nZ6H_aKtC604_Nvg&t=126",
        embedId: "RI-HOQ27QEM",
        startTime: 126,
    ...
    },
    {
        ...
        subtitle: "AHH GASLIGHTING FR",
        url: "https://youtu.be/5ZTEjjh7clE?si=WPiN3z5Xuu4zEHTQ&t=6",
        embedId: "5ZTEjjh7clE",
        startTime: 6,
    ...
    },
    {
        ...
        subtitle: "TBH i think this deserves more appreciation thn i showed",
        url: "https://youtu.be/3UV--8RA4ts?si=uvvRbiaCYVdLh-1J&t=43",
        embedId: "3UV--8RA4ts",
        startTime: 43,
    ...
    },
    {
        ...
        subtitle: "2nd June 2026",
        url: "https://youtu.be/WHHkVUaOxe4?si=07J7HvbGJdZpKk4K&t=2",
        embedId: "WHHkVUaOxe4",
        startTime: 2,
    ...
    },
    {
        ...
        subtitle: "AHH THIS 🥹",
        url: "https://youtu.be/xLT5wzJ0Crw?si=2FJUk7T3tP5q1vbA&t=8",
        embedId: "xLT5wzJ0Crw",
        startTime: 8,
    ...
    },
    {
        ...
        subtitle: "NAHH THE SWITCH UP IS CRAZY I SWEAR",
        url: "https://youtu.be/CEG4xZUP2qo?si=0zjR_oyfamu6XX-X&t=4",
        embedId: "CEG4xZUP2qo",
        startTime: 4,
    ...
    },
    {
        ...
        subtitle: "EH u thgt this ws the end nee",
        url: "https://youtu.be/Otv5AljKKhc?si=yS-tleFxShtCZVnT&t=7",
        embedId: "Otv5AljKKhc",
        startTime: 7,
...
albumTracks.forEach(track => {
    ...
    trackElement.onclick = () => openScroll(track);
    trackElement.innerHTML = `
        <div class="track-info">
            <div class="track-title">
                <span class="track-flower-icon">${track.flower}</span>
                <span>${track.title}</span>
            </div>
            <div class="track-subtitle">${track.subtitle}</div>
        </div>
        <div style="font-size: 1.2rem; color: #a08260;">📜</div>
    `;
...
function openScroll(track) {
    ...
    const title = document.getElementById('modal-track-title');
    const contentContainer = document.getElementById('modal-track-content');
    ...
    typeInterval = setInterval(() => {
        if (index < track.content.length) {
            contentContainer.innerHTML += track.content.charAt(index);
            index++;
...
for(let i = 0; i < 45; i++) {
    elements.push({
        ...
        color: Math.random() > 0.6 ? '#ffb7c5' : '#d4af37'
    });
}
